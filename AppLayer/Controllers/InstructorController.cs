...
namespace AppLayer.Controllers
{
    public class InstructorController : ApiController
    {
        ...
        //-----See All Panding Course Student Request-----//
        [HttpGet]
        [Route("api/instructor/studentrequest/")]
        public HttpResponseMessage CourseStudentRequest()
        {
            try
            {
                var data = InstructorService.CourseStudentRequest();
                return Request.CreateResponse(HttpStatusCode.OK, data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("api/instructor/confirmrequest/{studentId}/{courseId}")]
        public HttpResponseMessage CourseStudentConfirm(int studentId, int courseId)
        {
            try
            {
                var data = InstructorService.CourseStudentConfirm(studentId, courseId);
                return Request.CreateResponse(HttpStatusCode.OK, data);
            }
            catch (Exception ex)
            {
